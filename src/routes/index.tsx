...
function Home() {
  return (
    <main class="min-h-screen bg-white">
      <Title>TanStack Solid Boilerplate</Title>
      
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h1 class="text-5xl tracking-tight font-extrabold text-gray-900 sm:text-6xl md:text-7xl">
          <span class="block">TanStack Start & SolidJS</span>
          <span class="block text-primary mt-2">Clean Architecture Boilerplate</span>
        </h1>
        
        <p class="mt-8 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-12 md:text-xl md:max-w-3xl">
          A robust boilerplate featuring Prisma, SQLite, Tailwind v4, Solid-UI, and Clean Architecture for building scalable frontends.
        </p>
