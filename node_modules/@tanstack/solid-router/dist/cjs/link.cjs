...
//#region src/link.tsx
var _tmpl$ = /* @__PURE__ */ (0, solid_js_web.template)(`<svg><a>`), _tmpl$2 = /* @__PURE__ */ (0, solid_js_web.template)(`<a>`);
...
function useLinkProps(options) {
	...
	const currentLocation = solid_js.createMemo(() => router.stores.location.get(), void 0, { equals: (prev, next) => prev.href === next.href });
	...
	return solid_js.mergeProps(propsSafeToSpread, resolvedProps);
}
...
var Link = (props) => {
	...
	if (!local._asChild) return (() => {
		var _el$3 = _tmpl$2();
		(0, solid_js_web.spread)(_el$3, linkProps, false, true);
		(0, solid_js_web.insert)(_el$3, children);
		return _el$3;
	})();
