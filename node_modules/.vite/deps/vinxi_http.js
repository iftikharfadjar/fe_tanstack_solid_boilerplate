...
var w = Error;
var tt = Error;
var R = /* @__PURE__ */ Symbol.for("nodejs.rejection");
var f = /* @__PURE__ */ Symbol.for("kCapture");
var M = /* @__PURE__ */ Symbol.for("events.errorMonitor");
var g = /* @__PURE__ */ Symbol.for("shapeMode");
var b = /* @__PURE__ */ Symbol.for("events.maxEventTargetListeners");
var et = /* @__PURE__ */ Symbol.for("kEnhanceStackBeforeInspector");
var rt = /* @__PURE__ */ Symbol.for("nodejs.watermarkData");
var v = /* @__PURE__ */ Symbol.for("kAsyncResource");
var nt = /* @__PURE__ */ Symbol.for("kFirstEventParam");
var S = /* @__PURE__ */ Symbol.for("kResistStopPropagation");
var W = /* @__PURE__ */ Symbol.for("events.maxEventTargetListenersWarned");
var m = class _m {
  _events = void 0;
  _eventsCount = 0;
  _maxListeners = y;
  ...
  static setMaxListeners(t = y, ...r2) {
    if (r2.length === 0) y = t;
    else for (const n of r2) if (q(n)) n[b] = t, n[W] = false;
  ...
  static listenerCount(t, r2) {
    ...
    _m.prototype.listenerCount.call(t, r2);
  }
  static init() {
  ...
  constructor(t) {
    this._events === void 0 || this._events === Object.getPrototypeOf(this)._events ? (this._events = { __proto__: null }, this._eventsCount = 0, this[g] = false) : this[g] = true, this._maxListeners = this._maxListeners || void 0, t?.captureRejections ? this[f] = !!t.captureRejections : this[f] = _m.prototype[f];
  }
  setMaxListeners(t) {
  ...
  emit(t, ...r2) {
    ...
    if (s !== void 0) n && s[M] !== void 0 && this.emit(M, ...r2), n = n && s.error === void 0;
    else if (!n) return false;
    if (n) {
      let i2;
      if (r2.length > 0 && (i2 = r2[0]), i2 instanceof Error) {
        try {
          const a = {};
          Error.captureStackTrace?.(a, _m.prototype.emit), Object.defineProperty(i2, et, { __proto__: null, value: Function.prototype.bind(at, this, i2, a), configurable: true });
        } catch {
        }
        throw i2;
      }
    ...
    if (typeof o2 == "function") {
      const i2 = o2.apply(this, r2);
      i2 != null && z(this, i2, t, r2);
    } else {
      const i2 = o2.length, u = C(o2);
      for (let l2 = 0; l2 < i2; ++l2) {
        const a = u[l2].apply(this, r2);
        a != null && z(this, a, t, r2);
      }
    }
    return true;
  }
  addListener(t, r2) {
    return B(this, t, r2, false), this;
  }
  on(t, r2) {
    return this.addListener(t, r2);
  }
  prependListener(t, r2) {
    return B(this, t, r2, true), this;
  }
  once(t, r2) {
    return this.on(t, G(this, t, r2)), this;
  }
  prependOnceListener(t, r2) {
    return this.prependListener(t, G(this, t, r2)), this;
  }
  removeListener(t, r2) {
    ...
    if (s === r2 || s.listener === r2) this._eventsCount -= 1, this[g] ? n[t] = void 0 : this._eventsCount === 0 ? this._events = { __proto__: null } : (delete n[t], n.removeListener && this.emit("removeListener", t, s.listener || r2));
    else if (typeof s != "function") {
      let o2 = -1;
      for (let i2 = s.length - 1; i2 >= 0; i2--) if (s[i2] === r2 || s[i2].listener === r2) {
        o2 = i2;
        break;
      }
      if (o2 < 0) return this;
      o2 === 0 ? s.shift() : mt(s, o2), s.length === 1 && (n[t] = s[0]), n.removeListener !== void 0 && this.emit("removeListener", t, r2);
    }
    return this;
  }
  off(t, r2) {
  ...
  removeAllListeners(t) {
    ...
    if (r2.removeListener === void 0) return arguments.length === 0 ? (this._events = { __proto__: null }, this._eventsCount = 0) : r2[t] !== void 0 && (--this._eventsCount === 0 ? this._events = { __proto__: null } : delete r2[t]), this[g] = false, this;
    if (arguments.length === 0) {
      for (const s of Reflect.ownKeys(r2)) s !== "removeListener" && this.removeAllListeners(s);
  ...
  listenerCount(t, r2) {
    ...
    if (n !== void 0) {
      const s = n[t];
      if (typeof s == "function") return r2 != null ? r2 === s || r2 === s.listener ? 1 : 0 : 1;
      if (s !== void 0) {
        if (r2 != null) {
          let o2 = 0;
          for (let i2 = 0, u = s.length; i2 < u; i2++) (s[i2] === r2 || s[i2].listener === r2) && o2++;
          return o2;
        }
        return s.length;
      }
...
var st = class extends m {
  constructor(t) {
    let r2;
    typeof t == "string" ? (r2 = t, t = void 0) : r2 = t?.name || new.target.name, super(t), this[v] = new EventEmitterReferencingAsyncResource(this, r2, t);
  }
  emit(t, ...r2) {
    if (this[v] === void 0) throw new _("EventEmitterAsyncResource");
    const { asyncResource: n } = this;
    return Array.prototype.unshift(r2, super.emit, this, t), Reflect.apply(n.runInAsyncScope, n, r2);
  }
  emitDestroy() {
    if (this[v] === void 0) throw new _("EventEmitterAsyncResource");
...
var it = function(e, t, r2 = {}) {
  const n = r2.signal;
  if (n?.aborted) throw new w(void 0, { cause: n?.reason });
  const s = r2.highWaterMark ?? r2.highWatermark ?? Number.MAX_SAFE_INTEGER, o2 = r2.lowWaterMark ?? r2.lowWatermark ?? 1, i2 = new K(), u = new K();
  let l2 = false, a = null, p3 = false, d2 = 0;
  const H2 = Object.setPrototypeOf({ next() {
    if (d2) {
      const c2 = i2.shift();
      return d2--, l2 && d2 < o2 && (e.resume?.(), l2 = false), Promise.resolve(P(c2, false));
    }
    if (a) {
  ...
  x2(e, t, r2[nt] ? I : function(...c2) {
    return I(c2);
  }), t !== "error" && typeof e.on == "function" && x2(e, "error", A3);
  const T2 = r2?.close;
  if (T2?.length) for (const c2 of T2) x2(e, c2, L2);
  const Q2 = n ? $(n, V2) : null;
  return H2;
  function V2() {
    A3(new w(void 0, { cause: n?.reason }));
  }
  function I(c2) {
    u.isEmpty() ? (d2++, !l2 && d2 > s && (l2 = true, e.pause?.()), i2.push(c2)) : u.shift().resolve(P(c2, false));
  }
  function A3(c2) {
    u.isEmpty() ? a = c2 : u.shift().reject(c2), L2();
  }
  function L2() {
    Q2?.[Symbol.dispose](), J2(), p3 = true;
    const c2 = P(void 0, true);
    for (; !u.isEmpty(); ) u.shift().resolve(c2);
    return Promise.resolve(c2);
  }
};
var ot = async function(e, t, r2 = {}) {
  const n = r2?.signal;
  if (n?.aborted) throw new w(void 0, { cause: n?.reason });
  return new Promise((s, o2) => {
    ...
    function a() {
      E(e, t, u), E(e, "error", i2), o2(new w(void 0, { cause: n?.reason }));
    }
...
var $ = function(e, t) {
  ...
  let r2;
  return e.aborted ? queueMicrotask(() => t()) : (e.addEventListener("abort", t, { __proto__: null, once: true, [S]: true }), r2 = () => {
...
var ct = function(e, t) {
  ...
  if (q(e)) {
    const r2 = e[kEvents].get(t), n = [];
    let s = r2?.next;
    for (; s?.listener !== void 0; ) {
      const o2 = s.listener?.deref ? s.listener.deref() : s.listener;
      n.push(o2), s = s.next;
    }
    return n;
  }
...
var ut = function(e) {
  if (typeof e?.getMaxListeners == "function") return j(e);
  if (e?.[b]) return e[b];
  throw new h("emitter", ["EventEmitter", "EventTarget"], e);
};
var D = 2048;
...
var K = class {
  ...
  shift() {
    const t = this.tail, r2 = t.shift();
    return t.isEmpty() && t.next !== null && (this.tail = t.next, t.next = null), r2;
  }
};
function q(e) {
...
function lt(e, t, r2, n) {
  if (typeof e[R] == "function") e[R](t, r2, ...n);
  else {
    const s = e[f];
    try {
...
function at(e, t) {
  ...
  try {
    ...
    o2 !== "EventEmitter" && (r2 = ` on ${o2} instance`);
  } catch {
  }
  const n = `
...
function B(e, t, r2, n) {
  let s, o2, i2;
  if (o2 = e._events, o2 === void 0 ? (o2 = e._events = { __proto__: null }, e._eventsCount = 0) : (o2.newListener !== void 0 && (e.emit("newListener", t, r2.listener ?? r2), o2 = e._events), i2 = o2[t]), i2 === void 0) o2[t] = r2, ++e._eventsCount;
  else if (typeof i2 == "function" ? i2 = o2[t] = n ? [r2, i2] : [i2, r2] : n ? i2.unshift(r2) : i2.push(r2), s = j(e), s > 0 && i2.length > s && !i2.warned) {
    i2.warned = true;
...
function G(e, t, r2) {
  const n = { fired: false, wrapFn: void 0, target: e, type: t, listener: r2 }, s = ft.bind(n);
  return s.listener = r2, n.wrapFn = s, s;
}
function U(e, t, r2) {
  const n = e._events;
  if (n === void 0) return [];
  const s = n[t];
  return s === void 0 ? [] : typeof s == "function" ? r2 ? [s.listener || s] : [s] : r2 ? ht(s) : C(s);
}
function C(e) {
  switch (e.length) {
    case 2:
...
function vt() {
  const e = [];
  return { addEventListener(t, r2, n, s) {
    O(t, r2, n, s), Array.prototype.push(e, [t, r2, n, s]);
  }, removeAll() {
...
function ft2(t) {
  let e;
  const n = rt2(t), o2 = n[0], r2 = n[1], i2 = new ot2(it2(t, o2, r2));
  let u = 0;
  const h2 = r2 > 0 ? o2 - 4 : o2;
  let c2;
  ...
  return r2 === 2 && (e = y2[t.charCodeAt(c2)] << 2 | y2[t.charCodeAt(c2 + 1)] >> 4, i2[u++] = e & 255), r2 === 1 && (e = y2[t.charCodeAt(c2)] << 10 | y2[t.charCodeAt(c2 + 1)] << 4 | y2[t.charCodeAt(c2 + 2)] >> 2, i2[u++] = e >> 8 & 255, i2[u++] = e & 255), i2;
}
function ut2(t) {
...
function st2(t, e, n) {
  let o2;
  const r2 = [];
  for (let i2 = e; i2 < n; i2 += 3) o2 = (t[i2] << 16 & 16711680) + (t[i2 + 1] << 8 & 65280) + (t[i2 + 2] & 255), r2.push(ut2(o2));
  return r2.join("");
}
function P2(t) {
  let e;
  const n = t.length, o2 = n % 3, r2 = [], i2 = 16383;
  for (let u = 0, h2 = n - o2; u < h2; u += i2) r2.push(st2(t, u, u + i2 > h2 ? h2 : u + i2));
  return o2 === 1 ? (e = t[n - 1], r2.push(d[e >> 2] + d[e << 4 & 63] + "==")) : o2 === 2 && (e = (t[n - 2] << 8) + t[n - 1], r2.push(d[e >> 10] + d[e >> 4 & 63] + d[e << 2 & 63] + "=")), r2.join("");
}
function R2(t, e, n, o2, r2) {
  let i2, u;
  const h2 = r2 * 8 - o2 - 1, c2 = (1 << h2) - 1, l2 = c2 >> 1;
  let s = -7, a = n ? r2 - 1 : 0;
  const I = n ? -1 : 1;
  let w3 = t[e + a];
...
function F2(t, e, n, o2, r2, i2) {
  let u, h2, c2, l2 = i2 * 8 - r2 - 1;
  const s = (1 << l2) - 1, a = s >> 1, I = r2 === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
  let w3 = o2 ? 0 : i2 - 1;
  const O2 = o2 ? 1 : -1, nt2 = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), Number.isNaN(e) || e === Number.POSITIVE_INFINITY ? (h2 = Number.isNaN(e) ? 1 : 0, u = s) : (u = Math.floor(Math.log2(e)), e * (c2 = Math.pow(2, -u)) < 1 && (u--, c2 *= 2), e += u + a >= 1 ? I / c2 : I * Math.pow(2, 1 - a), e * c2 >= 2 && (u++, c2 /= 2), u + a >= s ? (h2 = 0, u = s) : u + a >= 1 ? (h2 = (e * c2 - 1) * Math.pow(2, r2), u = u + a) : (h2 = e * Math.pow(2, a - 1) * Math.pow(2, r2), u = 0)); r2 >= 8; ) t[n + w3] = h2 & 255, w3 += O2, h2 /= 256, r2 -= 8;
  for (u = u << r2 | h2, l2 += r2; l2 > 0; ) t[n + w3] = u & 255, w3 += O2, u /= 256, l2 -= 8;
  t[n + w3 - O2] |= nt2 * 128;
}
var k2 = typeof Symbol == "function" && typeof Symbol.for == "function" ? /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") : null;
var ht2 = 50;
var N2 = 2147483647;
...
function lt2(t, e) {
  ...
  const n = z2(t, e) | 0;
  let o2 = m2(n);
  const r2 = o2.write(t, e);
  return r2 !== n && (o2 = o2.slice(0, r2)), o2;
}
function _2(t) {
...
f2.isBuffer = function(t) {
  ...
  for (let r2 = 0, i2 = Math.min(n, o2); r2 < i2; ++r2) if (t[r2] !== e[r2]) {
    n = t[r2], o2 = e[r2];
    break;
  }
  ...
  for (n = 0; n < t.length; ++n) {
    let i2 = t[n];
    if (b2(i2, Uint8Array)) r2 + i2.length > o2.length ? (f2.isBuffer(i2) || (i2 = f2.from(i2.buffer, i2.byteOffset, i2.byteLength)), i2.copy(o2, r2)) : Uint8Array.prototype.set.call(o2, i2, r2);
    else if (f2.isBuffer(i2)) i2.copy(o2, r2);
...
f2.prototype.swap16 = function() {
...
}, k2 && (f2.prototype[k2] = f2.prototype.inspect), f2.prototype.compare = function(t, e, n, o2, r2) {
  ...
  if (e === void 0 && (e = 0), n === void 0 && (n = t ? t.length : 0), o2 === void 0 && (o2 = 0), r2 === void 0 && (r2 = this.length), e < 0 || n > t.length || o2 < 0 || r2 > this.length) throw new RangeError("out of range index");
  if (o2 >= r2 && e >= n) return 0;
  if (o2 >= r2) return -1;
  if (e >= n) return 1;
  if (e >>>= 0, n >>>= 0, o2 >>>= 0, r2 >>>= 0, this === t) return 0;
  let i2 = r2 - o2, u = n - e;
  const h2 = Math.min(i2, u), c2 = this.slice(o2, r2), l2 = t.slice(e, n);
...
function V(t, e, n, o2, r2) {
  if (t.length === 0) return -1;
  if (typeof n == "string" ? (o2 = n, n = 0) : n > 2147483647 ? n = 2147483647 : n < -2147483648 && (n = -2147483648), n = +n, M2(n) && (n = r2 ? 0 : t.length - 1), n < 0 && (n = t.length + n), n >= t.length) {
    if (r2) return -1;
    n = t.length - 1;
  } else if (n < 0) if (r2) n = 0;
  else return -1;
  if (typeof e == "string" && (e = f2.from(e, o2)), f2.isBuffer(e)) return e.length === 0 ? -1 : G2(t, e, n, o2, r2);
  if (typeof e == "number") return e = e & 255, typeof Uint8Array.prototype.indexOf == "function" ? r2 ? Uint8Array.prototype.indexOf.call(t, e, n) : Uint8Array.prototype.lastIndexOf.call(t, e, n) : G2(t, [e], n, o2, r2);
  throw new TypeError("val must be string, number or Buffer");
}
function G2(t, e, n, o2, r2) {
...
function wt(t, e, n, o2) {
  n = Number(n) || 0;
  const r2 = t.length - n;
  o2 ? (o2 = Number(o2), o2 > r2 && (o2 = r2)) : o2 = r2;
  const i2 = e.length;
  o2 > i2 / 2 && (o2 = i2 / 2);
  let u;
  for (u = 0; u < o2; ++u) {
...
f2.prototype.write = function(t, e, n, o2) {
  ...
  const r2 = this.length - e;
  if ((n === void 0 || n > r2) && (n = r2), t.length > 0 && (n < 0 || e < 0) || e > this.length) throw new RangeError("Attempt to write outside buffer bounds");
  o2 || (o2 = "utf8");
  let i2 = false;
  for (; ; ) switch (o2) {
    case "hex":
  ...
  for (; r2 < n; ) {
    ...
    if (r2 + h2 <= n) {
      ...
      switch (h2) {
        ...
        case 2: {
          c2 = t[r2 + 1], (c2 & 192) === 128 && (a = (i2 & 31) << 6 | c2 & 63, a > 127 && (u = a));
          break;
        }
        case 3: {
          c2 = t[r2 + 1], l2 = t[r2 + 2], (c2 & 192) === 128 && (l2 & 192) === 128 && (a = (i2 & 15) << 12 | (c2 & 63) << 6 | l2 & 63, a > 2047 && (a < 55296 || a > 57343) && (u = a));
          break;
        }
        case 4:
          c2 = t[r2 + 1], l2 = t[r2 + 2], s = t[r2 + 3], (c2 & 192) === 128 && (l2 & 192) === 128 && (s & 192) === 128 && (a = (i2 & 15) << 18 | (c2 & 63) << 12 | (l2 & 63) << 6 | s & 63, a > 65535 && a < 1114112 && (u = a));
      }
    }
    u === null ? (u = 65533, h2 = 1) : u > 65535 && (u -= 65536, o2.push(u >>> 10 & 1023 | 55296), u = 56320 | u & 1023), o2.push(u), r2 += h2;
  }
  return It(o2);
}
var W2 = 4096;
...
function At(t, e, n) {
  let o2 = "";
  n = Math.min(t.length, n);
  for (let r2 = e; r2 < n; ++r2) o2 += String.fromCharCode(t[r2] & 127);
  return o2;
}
function Ut(t, e, n) {
  let o2 = "";
  n = Math.min(t.length, n);
  for (let r2 = e; r2 < n; ++r2) o2 += String.fromCharCode(t[r2]);
  return o2;
}
function vt2(t, e, n) {
  const o2 = t.length;
  ...
  let r2 = "";
  for (let i2 = e; i2 < n; ++i2) r2 += _t[t[i2]];
  return r2;
}
function Rt(t, e, n) {
  const o2 = t.slice(e, n);
  let r2 = "";
  for (let i2 = 0; i2 < o2.length - 1; i2 += 2) r2 += String.fromCharCode(o2[i2] + o2[i2 + 1] * 256);
  return r2;
}
...
f2.prototype.readUintLE = f2.prototype.readUIntLE = function(t, e, n) {
  ...
  let o2 = this[t], r2 = 1, i2 = 0;
  for (; ++i2 < e && (r2 *= 256); ) o2 += this[t + i2] * r2;
  return o2;
}, f2.prototype.readUintBE = f2.prototype.readUIntBE = function(t, e, n) {
  t = t >>> 0, e = e >>> 0, n || p(t, e, this.length);
  let o2 = this[t + --e], r2 = 1;
  for (; e > 0 && (r2 *= 256); ) o2 += this[t + --e] * r2;
  return o2;
  ...
  const o2 = e + this[++t] * 2 ** 8 + this[++t] * 2 ** 16 + this[++t] * 2 ** 24, r2 = this[++t] + this[++t] * 2 ** 8 + this[++t] * 2 ** 16 + n * 2 ** 24;
  return BigInt(o2) + (BigInt(r2) << BigInt(32));
}), f2.prototype.readBigUInt64BE = E2(function(t) {
  t = t >>> 0, U2(t, "offset");
  const e = this[t], n = this[t + 7];
  (e === void 0 || n === void 0) && v2(t, this.length - 8);
  const o2 = e * 2 ** 24 + this[++t] * 2 ** 16 + this[++t] * 2 ** 8 + this[++t], r2 = this[++t] * 2 ** 24 + this[++t] * 2 ** 16 + this[++t] * 2 ** 8 + n;
  return (BigInt(o2) << BigInt(32)) + BigInt(r2);
}), f2.prototype.readIntLE = function(t, e, n) {
  t = t >>> 0, e = e >>> 0, n || p(t, e, this.length);
  let o2 = this[t], r2 = 1, i2 = 0;
  for (; ++i2 < e && (r2 *= 256); ) o2 += this[t + i2] * r2;
  return r2 *= 128, o2 >= r2 && (o2 -= Math.pow(2, 8 * e)), o2;
}, f2.prototype.readIntBE = function(t, e, n) {
  t = t >>> 0, e = e >>> 0, n || p(t, e, this.length);
  let o2 = e, r2 = 1, i2 = this[t + --o2];
  for (; o2 > 0 && (r2 *= 256); ) i2 += this[t + --o2] * r2;
  return r2 *= 128, i2 >= r2 && (i2 -= Math.pow(2, 8 * e)), i2;
...
function g2(t, e, n, o2, r2, i2) {
  if (!f2.isBuffer(t)) throw new TypeError('"buffer" argument must be a Buffer instance');
  if (e > r2 || e < i2) throw new RangeError('"value" argument is out of bounds');
...
f2.prototype.writeUintLE = f2.prototype.writeUIntLE = function(t, e, n, o2) {
  ...
  let r2 = 1, i2 = 0;
  for (this[e] = t & 255; ++i2 < n && (r2 *= 256); ) this[e + i2] = t / r2 & 255;
  return e + n;
  ...
  let r2 = n - 1, i2 = 1;
  for (this[e + r2] = t & 255; --r2 >= 0 && (i2 *= 256); ) this[e + r2] = t / i2 & 255;
  return e + n;
...
f2.prototype.writeBigUInt64LE = E2(function(t, e = 0) {
  ...
  let r2 = 0, i2 = 1, u = 0;
  for (this[e] = t & 255; ++r2 < n && (i2 *= 256); ) t < 0 && u === 0 && this[e + r2 - 1] !== 0 && (u = 1), this[e + r2] = Math.trunc(t / i2) - u & 255;
  return e + n;
  ...
  let r2 = n - 1, i2 = 1, u = 0;
  for (this[e + r2] = t & 255; --r2 >= 0 && (i2 *= 256); ) t < 0 && u === 0 && this[e + r2 + 1] !== 0 && (u = 1), this[e + r2] = Math.trunc(t / i2) - u & 255;
  return e + n;
...
function H(t, e, n, o2, r2, i2) {
  if (n + o2 > t.length) throw new RangeError("Index out of range");
  if (n < 0) throw new RangeError("Index out of range");
}
function K2(t, e, n, o2, r2) {
  return e = +e, n = n >>> 0, r2 || H(t, e, n, 4), F2(t, e, n, o2, 23, 4), n + 4;
}
...
function Q(t, e, n, o2, r2) {
  return e = +e, n = n >>> 0, r2 || H(t, e, n, 8), F2(t, e, n, o2, 52, 8), n + 8;
}
f2.prototype.writeDoubleLE = function(t, e, n) {
  ...
  const r2 = o2 - n;
  return this === t && typeof Uint8Array.prototype.copyWithin == "function" ? this.copyWithin(e, n, o2) : Uint8Array.prototype.set.call(t, this.subarray(n, o2), e), r2;
...
C2("ERR_BUFFER_OUT_OF_BOUNDS", function(t) {
  ...
  let o2 = `The value of "${t}" is out of range.`, r2 = n;
  return Number.isInteger(n) && Math.abs(n) > 2 ** 32 ? r2 = Z2(String(n)) : typeof n == "bigint" && (r2 = String(n), (n > BigInt(2) ** BigInt(32) || n < -(BigInt(2) ** BigInt(32))) && (r2 = Z2(r2)), r2 += "n"), o2 += ` It must be ${e}. Received ${r2}`, o2;
}, RangeError);
function Z2(t) {
  let e = "", n = t.length;
  const o2 = t[0] === "-" ? 1 : 0;
...
function $2(t, e) {
  ...
  for (let u = 0; u < o2; ++u) {
    if (n = t.charCodeAt(u), n > 55295 && n < 57344) {
      ...
      if (n < 56320) {
        (e -= 3) > -1 && i2.push(239, 191, 189), r2 = n;
        continue;
      }
      n = (r2 - 55296 << 10 | n - 56320) + 65536;
    } else r2 && (e -= 3) > -1 && i2.push(239, 191, 189);
    if (r2 = null, n < 128) {
      if ((e -= 1) < 0) break;
      i2.push(n);
    } else if (n < 2048) {
...
function St(t, e) {
  let n, o2, r2;
  const i2 = [];
  for (let u = 0; u < t.length && !((e -= 2) < 0); ++u) n = t.charCodeAt(u), o2 = n >> 8, r2 = n % 256, i2.push(r2, o2);
  return i2;
}
function et2(t) {
  return ft2(Lt(t));
...
function T(t, e, n, o2) {
  let r2;
  for (r2 = 0; r2 < o2 && !(r2 + n >= e.length || r2 >= t.length); ++r2) e[r2 + n] = t[r2];
  return r2;
}
function b2(t, e) {
...
var _t = (function() {
  ...
  for (let n = 0; n < 16; ++n) {
    const o2 = n * 16;
    for (let r2 = 0; r2 < 16; ++r2) e[o2 + r2] = t[n] + t[r2];
  }
  return e;
})();
function E2(t) {
...
var l = class extends m {
  ...
  write(e, t, r2) {
    const s = typeof t == "string" ? this._encoding : "utf8", a = typeof t == "function" ? t : typeof r2 == "function" ? r2 : void 0;
  ...
  setDefaultEncoding(e) {
    ...
    const s = typeof e == "function" ? e : typeof t == "function" ? t : typeof r2 == "function" ? r2 : void 0;
...
var y3 = class extends i {
  ...
  readable = false;
  constructor(e) {
    super(), this.socket = this.connection = e || new A2();
  }
  get rawHeaders() {
...
function p2(n) {
  const e = {};
  for (const [t, r2] of Object.entries(n)) t && (e[t] = (Array.isArray(r2) ? r2 : [r2]).filter(Boolean));
  return e;
}
...
function process2(data, headers) {
  const dataObj = {};
  const contentDispositionHeader = headers.find((h2) => h2[0] === "content-disposition")?.[1] || "";
  ...
  const contentType = headers.find((h2) => h2[0] === "content-type")?.[1] || "";
  if (contentType) {
...
var getSessionPromise = /* @__PURE__ */ Symbol("getSession");
var DEFAULT_NAME = "h3";
var DEFAULT_COOKIE = {
  path: "/",
  secure: true,
